...
def sacar(saldo, extrato, numero_saques, limite , limite_saques, valor):
    if valor > saldo:
...
def main():
    ...
    while True:
        ...
        if opcao == 1:
            ...
            saldo, extrato , numero_saques = sacar (saldo,extrato,numero_saques,limite,LIMITE_SAQUES,valor)
        
        elif opcao == 3:
            emitir_extrato(saldo, extrato)

        elif opcao == 4:
            break

        else:
            print("Opção inválida, informe novamente a operação desejada")
